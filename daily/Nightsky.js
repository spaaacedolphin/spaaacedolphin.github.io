...
function drawEarth(){
  ...
  document.querySelector("#fracYear").innerText = "Year Progress: "+(fracYear*100).toFixed(2)+"%";
  //console.log(newYear);
  //console.log(endYear);
...
function drawMoon(){
  ...
  document.querySelector("#phase").innerText ="Lunation Progress: "+(moonPhase*100).toFixed(2)+"%";
